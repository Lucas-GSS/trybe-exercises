...
const sendMarsTemperature = () => console.log(); // imprime "It is currently 47ºF at Mars", por exemplo
sendMarsTemperature(temperatureInFahrenheit(toFahrenheit(getMarsTemperature())));
