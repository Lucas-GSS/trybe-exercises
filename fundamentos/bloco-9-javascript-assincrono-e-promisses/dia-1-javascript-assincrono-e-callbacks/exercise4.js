...
const sendMarsTemperature = () => console.log(`Mars tempeture is: ${getMarsTemperature()} degree Celsius`); // imprime "Mars temperature is: 20 degree Celsius", por exemplo
messageDelay(sendMarsTemperature());