...
describe("a função verifyCredentials()", () => {
  // O teste em Jest é escrito usando a função test ou it, que funcionam do mesmo jeito, e essa função recebe 2 parâmetros obrigatórios e 1 opcional. Os 2 primeiro são uma descrição da função a ser testada e a função que contém o teste e a terceira é o tempo de espera para abortar o teste. 
  it("verifyCredentials() calls the correct function depending on the user and password input" /* descrição */, () => {
